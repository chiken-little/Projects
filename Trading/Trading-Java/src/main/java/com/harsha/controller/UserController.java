...
import com.harsha.request.ForgotPasswordTokenRequest;
...
public class UserController {
    ...
    public ResponseEntity<String> sendVerificationOtp(
        ...
        if(verificationCode==null){
            verificationCode = verificationCodeService.sendVerificationCodeOtp(user,verificationType);
        }
